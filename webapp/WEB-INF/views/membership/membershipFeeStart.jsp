	...
	<div class="container">
		<div class="carousel-item active">
			...
			<div class="mb-0">
				...
				<a class="btn btn-primary btn-lg ml-5 mt-0" style="text-shadow:none; " href="${pageContext.request.contextPath }/membershipfee/${gvo.groupNo}/membershipsetting">회비설정하기</a>
				<br>
			</div>
