...
public class ModuGroupVo {
   ...
   public ModuGroupVo(int groupNo, String groupName, String groupExplain, String groupImg, String groupType,
         int memberFeeAmount, String memberFeeDate, int memberFeeinterval, int manager, String groupBank,
         String groupAccount, String groupAccountHolder, String isJoin, String joinState) {
   ...
   public String toString() {
      return "ModuGroupVo [groupNo=" + groupNo + ", groupName=" + groupName + ", groupExplain=" + groupExplain
            ...
            + groupAccountHolder + ", isJoin=" + isJoin + ", joinState=" + joinState + "]";
   }
